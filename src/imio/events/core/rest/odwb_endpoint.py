...
class OdwbEndpointGet(Service):
    ...
    def reply(self):
        url = "https://www.odwb.be/api/push/1.0/test-push-evenement/temps_reel/push/?pushkey=4e04242e9b2239999f34f835a95658748480a055d26c16c0ac740d34"
        ...
        try:
            ...
            logging.error("ODWB : Connection error: %s", e)
            return "ODWB : Connection error occurred"
        except requests.exceptions.Timeout as e:
            logging.error("ODWB : Request timed out: %s", e)
            return "ODWB : Request timed out"
        except requests.exceptions.HTTPError as e:
            logging.error("ODWB : HTTP error occurred: %s", e)
            return "ODWB : HTTP error occurred"
        except Exception as e:
            logging.error("ODWB : An unexpected error occurred: %s", e)
    ...
    def removed(self):
        ...
        if IEvent.providedBy(self.context):
            event = Event(self.context)
            lst_events.append(json.loads(event.to_json()))
        url = "https://www.odwb.be/api/push/1.0/test-push-evenement/temps_reel/delete/?pushkey=4e04242e9b2239999f34f835a95658748480a055d26c16c0ac740d34"
...
class OdwbEntitiesEndpointGet(Service):
    ...
    def reply(self):
        ...
        url = "https://www.odwb.be/api/push/1.0/imio-agenda-entites/temps_reel/push/?pushkey=0cf1907294216937770feaf412589bcf12ef438d2e77ef9b617b2f2b"
